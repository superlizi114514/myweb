<template>
  <div class="min-h-screen bg-gradient-to-br from-[#0f0c29] via-[#302b63] to-[#24243e]">
    <!-- Navigation -->
    <nav class="fixed top-0 left-0 right-0 z-50 bg-white/10 backdrop-blur-md border-white/10 border-b border-apple-gray-100">
      <div class="max-w-5xl mx-auto px-6">
        <div class="flex items-center justify-between h-12">
          <router-link to="/" class="text-white font-bold text-base hover:text-apple-gray-600 transition-colors">
            Welcome
          </router-link>
          
          <div class="flex items-center space-x-6">
            <router-link to="/about" class="text-gray-300 text-sm hover:text-white hover:scale-105 hover:text-purple-400 transition-all duration-300">
              About
            </router-link>
            <router-link to="/projects" class="text-gray-300 text-sm hover:text-white hover:scale-105 hover:text-purple-400 transition-all duration-300">
              Projects
            </router-link>
    ...
    <!-- Footer -->
    <footer class="bg-apple-gray-50 border-t border-apple-gray-100 py-8">
      <div class="max-w-5xl mx-auto px-6">
