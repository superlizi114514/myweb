<template>
  <div class="projects-page">
    ...
    <div class="grid md:grid-cols-2 gap-8">
      <div v-for="project in filteredProjects" :key="project.id" class="group cursor-pointer" @click="$router.push(project.link)">
        ...
        <span class="inline-flex items-center mt-4 text-purple-400 hover:text-purple-300 text-sm font-medium transition-colors">
          View Project →
        </span>
      </div>
    </div>
