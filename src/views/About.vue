    ...
    <div class="max-w-4xl mx-auto px-6 py-24">
      ...
      <div class="flex justify-center mb-12">
        <div class="w-48 h-48 rounded-full overflow-hidden bg-gradient-to-br from-blue-500 to-purple-600 p-1 shadow-lg">
          <img src="/avatar.jpg" alt="Profile" class="w-full h-full rounded-full object-cover transparent" loading="eager" fetchpriority="high" />
        </div>
      </div>
      ...
      <div class="mb-16">
        ...
        <div class="space-y-8">
          <div v-for="(item, index) in timeline" :key="index" class="relative pl-8 border-l-2 border-purple-500/50">
            ...
            <p class="text-gray-200">{{ item.company }}</p>
        ...
        <div class="grid md:grid-cols-2 gap-6">
          <div v-for="(category, catIndex) in skillsCategories" :key="catIndex">
            ...
            <div class="flex flex-wrap gap-2">
              <span v-for="skill in category.skills" :key="skill" class="bg-white/10 px-4 py-2 rounded-lg text-sm text-white border border-purple-500/50 hover:border-purple-400 hover:shadow-md transition-all">
                {{ skill }}
              </span>
            </div>
          </div>
